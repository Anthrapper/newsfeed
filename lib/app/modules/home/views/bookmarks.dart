            ...
            Flexible(
              child: Obx(
                () => ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: Get.find<HomeController>().offLineKeys.length,
                  itemBuilder: (context, index) {
                    return Column(
                      ...
                      children: <Widget>[
                        ...
                        Image.network(
                          Get.find<HomeController>().offLineData[0][
                              Get.find<HomeController>().offLineKeys[index]][0],
                          fit: BoxFit.cover,
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Text(Get.find<HomeController>().offLineData[0][
                                  Get.find<HomeController>().offLineKeys[index]]
                              [1]),
                        ),
                      ],
                    );
